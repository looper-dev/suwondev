---
title: ไซต์นี้เกิดขึ้นได้อย่างไร 👶
...
เว็บไซต์นี้สร้างขึ้นโดยใช้ Jekyll ซึ่งเป็นหนึ่งในเครื่องมือสร้างไซต์คงที่แบบโอเพ่นซอร์ส และใช้ธีมง่ายๆ ของฉันเอง [klisé](https://github.com/piharpi/klise).
